...
<?php include("../../templates/control-header.php"); ?>
    <div id="btnGroup">
      <button id="btnNone" class="button button-primary">none</button>
      <button id="btnLinear" class="button button-primary">linear</button>
      <button id="btnSlide" class="button button-primary">slide</button>
      <button id="btnFade" class="button button-primary">fade</button>
